import { c as S, i as C, n as joinClassNames, r as u, u as k } from "./c912f986-C5K_a9LL.js";
import { $ as EVENT_UI_REFINERS, At as guid, Bt as parseDateSpan, Et as getElEventRange, Ft as isPropsEqualShallow, G as isMergedPropsEqual, Gt as sliceEventStore, Ht as parseEvents, It as listenBySelector, J as BASE_OPTION_DEFAULTS, Jt as triggerDateUnselect, K as mergeCalendarOptions, Lt as listenToHoverBySelector, M as memoize, Mt as hashValuesToArray, N as memoizeObjArg, Nt as identity, O as getIsHeightAuto, Ot as getRangeInstantEndMs, Pt as isArraysEqual, Q as COMPLEX_OPTION_COMPARATORS, Qt as addDays, Rt as mapHash, St as filterHash, T as generateClassName, Tt as formatWithOrdinals, Ut as refineProps, V as applyStyleProp, Vt as parseEvent, X as CALENDAR_LISTENER_REFINERS, Xt as classNames, Y as BASE_OPTION_REFINERS, Yt as warn, Z as CALENDAR_ONLY_OPTION_REFINERS, Zt as DateEnv, _t as eventTupleToStore, a as ContentContainer, at as buildEventInstanceRange, b as buildViewContext, bn as pn, d as RenderId, dn as joinDateTimeFormatParts, dt as computeViewBorderless, en as addMs, et as EventImpl, gt as eventApiToStore, h as ViewContextType, hn as subtractDurations, ht as createFormatter, i as BaseComponent, it as buildEventApis, kt as getRangeInstantStartMs, l as NowTimerRunner, ln as greatestDurationDenominator, lt as buildValidInstanceRange, mn as startOfDay, mt as createEventUi, nt as VIEW_ONLY_OPTION_REFINERS, on as diffWholeDays, pn as rangeContainsMarker, pt as createEmptyEventStore, q as mergeViewOptionsMap, qt as triggerDateSelect, rn as createDuration, rt as arrayToHash, s as DelayedRunner, st as buildRangeApiWithTimeZone, t as DateProfileGenerator, tt as EventSourceImpl, u as PureComponent, un as intersectRanges, vn as bn, vt as excludeSubEventStore, w as flushSyncWithSizeBatching, xt as filterEventStoreDefs, yn as nn, yt as expandRecurring, z as Emitter, zt as mergeEventStores } from "./54e239b5-DsJsCsr-.js";
...
//#endregion
//#region node_modules/fullcalendar/chunks/71d3d952.js
var globalLocales = [];
...
//#endregion
//#region node_modules/fullcalendar/chunks/b00ce53f.js
...
function rezoneEventStoreDates(eventStore, oldDateEnv, newDateEnv) {
	...
	return {
		...
		instances: mapHash(eventStore.instances, (instance) => {
			...
			let start = instantStartMs != null ? newDateEnv.timestampToMarker(instantStartMs) : newDateEnv.createMarker(oldDateEnv.toDate(instance.range.start));
			let end = instantEndMs != null ? newDateEnv.timestampToMarker(instantEndMs) : newDateEnv.createMarker(oldDateEnv.toDate(instance.range.end));
			return {
				...instance,
				range: buildValidInstanceRange({
					marker: start,
					instantMs: instantStartMs
				}, {
					marker: end,
					instantMs: instantEndMs
				}, newDateEnv) ?? buildEventInstanceRange(start, addMs(start, getRangeInstantEndMs(instance.range, oldDateEnv) - getRangeInstantStartMs(instance.range, oldDateEnv)), instantStartMs)
			};
		})
	};
}
...
//#endregion
//#region node_modules/fullcalendar/chunks/65e4f9c4.js
...
var CalendarNowManager = class {
	...
	handleInput(dateEnv, nowInput) {
		...
		if (dateEnv !== oldDateEnv) {
			if (typeof nowInput === "function") this.nowFn = nowInput;
				...
				this.nowAnchorDate = nowInput ? resolveInputToDate(nowInput, dateEnv) : /* @__PURE__ */ new Date();
	...
	getEpochMs() {
		return this.nowAnchorDate ? this.nowAnchorDate.valueOf() + (Date.now() - this.nowAnchorQueried) : resolveInputToDate(this.nowFn(), this.dateEnv).valueOf();
	}
...
function resolveInputToDate(input, dateEnv) {
	...
	return meta.instantMs != null ? new Date(meta.instantMs) : dateEnv.toDate(meta.marker);
}
...
var Toolbar = class extends BaseComponent {
	render() {
		...
		return u("div", {
			className: joinClassNames(generateClassName(toolbarClassOption, {
				borderlessX,
				borderlessTop,
				borderlessBottom
...
//#endregion
//#region node_modules/fullcalendar/chunks/6143324c.js
...
//#endregion
//#region node_modules/fullcalendar/chunks/4eaa704d.js
...
function formatDate(dateInput, options = {}) {
	...
	if (!dateMeta) return "";
	return joinDateTimeFormatParts(dateEnv.formatToParts(dateMeta.marker, formatter, { instantMs: dateMeta.instantMs }));
}
...
var version = "7.1.0";
//#endregion
export { Calendar, Calendar as default, CalendarController, JsonRequestError, formatDate, formatRange, globalLocales, globalPlugins, joinClassNames, sliceEvents, version };
